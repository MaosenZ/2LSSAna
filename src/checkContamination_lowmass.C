...
void checkContamination_lowmass(TString masspoint,Int_t input_channel){
  SetAtlasStyle();
  //low mass
  ...
  Float_t mH260_m_all,mH300_m_all,mH400_m_all,mH500_m_all,nonres_m_all,totalbkg_m_all,data_m_all;
  ...
  mH260->SetBranchAddress("m_all",&mH260_m_all);
  mH300->SetBranchAddress("m_all",&mH300_m_all);
  mH400->SetBranchAddress("m_all",&mH400_m_all);
  mH500->SetBranchAddress("m_all",&mH500_m_all);
  nonres->SetBranchAddress("m_all",&nonres_m_all);
  ...
  for(Int_t index=0;index<4;index++){
      for(Long64_t entry=0; entry<mH260->GetEntries();entry++) {
          ...
          if(index==0 &&mH260_mindR_l1j>fixed_cuts_min[0]&&mH260_mindR_l1j<fixed_cuts_max[0]){
             numOfmH260[index]++;
             numOfwgtmH260[index]+=mH260_weight; Err2OfwgtmH260[index]+=mH260_weight*mH260_weight;
          }
          if(index==1 && mH260_mindR_l1j>fixed_cuts_min[0]&&mH260_mindR_l1j<fixed_cuts_max[0] &&
                         mH260_m_ll>fixed_cuts_min[1]&&mH260_m_ll<fixed_cuts_max[1]){
             numOfmH260[index]++;
             numOfwgtmH260[index]+=mH260_weight; Err2OfwgtmH260[index]+=mH260_weight*mH260_weight;
          }
          if(index==2 && mH260_mindR_l1j>fixed_cuts_min[0]&&mH260_mindR_l1j<fixed_cuts_max[0] &&
                         mH260_m_ll>fixed_cuts_min[1]&&mH260_m_ll<fixed_cuts_max[1] &&
                         mH260_m_l1jj>fixed_cuts_min[2]&&mH260_m_l1jj<fixed_cuts_max[2]){
             numOfmH260[index]++;
             numOfwgtmH260[index]+=mH260_weight; Err2OfwgtmH260[index]+=mH260_weight*mH260_weight;
          }
          if(index==3&&mH260_mindR_l1j>fixed_cuts_min[0]&&mH260_mindR_l1j<fixed_cuts_max[0] &&
                         mH260_m_ll>fixed_cuts_min[1]&&mH260_m_ll<fixed_cuts_max[1] &&
                         mH260_m_l1jj>fixed_cuts_min[2]&&mH260_m_l1jj<fixed_cuts_max[2] &&
                         mH260_m_all>fixed_cuts_min[3]&&mH260_m_all<fixed_cuts_max[3]){
              numOfmH260[index]++;
             numOfwgtmH260[index]+=mH260_weight; Err2OfwgtmH260[index]+=mH260_weight*mH260_weight;
          }
      }
      for(Long64_t entry=0; entry<mH300->GetEntries();entry++) {
          ...
          if(index==0 &&mH300_mindR_l1j>fixed_cuts_min[0]&&mH300_mindR_l1j<fixed_cuts_max[0]){
             numOfmH300[index]++;
             numOfwgtmH300[index]+=mH300_weight; Err2OfwgtmH300[index]+=mH300_weight*mH300_weight;
          }
          if(index==1 && mH300_mindR_l1j>fixed_cuts_min[0]&&mH300_mindR_l1j<fixed_cuts_max[0] &&
                         mH300_m_ll>fixed_cuts_min[1]&&mH300_m_ll<fixed_cuts_max[1]){
             numOfmH300[index]++;
             numOfwgtmH300[index]+=mH300_weight; Err2OfwgtmH300[index]+=mH300_weight*mH300_weight;
          }
          if(index==2 && mH300_mindR_l1j>fixed_cuts_min[0]&&mH300_mindR_l1j<fixed_cuts_max[0] &&
                         mH300_m_ll>fixed_cuts_min[1]&&mH300_m_ll<fixed_cuts_max[1] &&
                         mH300_m_l1jj>fixed_cuts_min[2]&&mH300_m_l1jj<fixed_cuts_max[2]){
             numOfmH300[index]++;
             numOfwgtmH300[index]+=mH300_weight; Err2OfwgtmH300[index]+=mH300_weight*mH300_weight;
          }
          if(index==3&&mH300_mindR_l1j>fixed_cuts_min[0]&&mH300_mindR_l1j<fixed_cuts_max[0] &&
                         mH300_m_ll>fixed_cuts_min[1]&&mH300_m_ll<fixed_cuts_max[1] &&
                         mH300_m_l1jj>fixed_cuts_min[2]&&mH300_m_l1jj<fixed_cuts_max[2] &&
                         mH300_m_all>fixed_cuts_min[3]&&mH300_m_all<fixed_cuts_max[3]){
              numOfmH300[index]++;
             numOfwgtmH300[index]+=mH300_weight; Err2OfwgtmH300[index]+=mH300_weight*mH300_weight;
          }
      }
      for(Long64_t entry=0; entry<mH400->GetEntries();entry++) {
          ...
          if(index==0 &&mH400_mindR_l1j>fixed_cuts_min[0]&&mH400_mindR_l1j<fixed_cuts_max[0]){
             numOfmH400[index]++;
             numOfwgtmH400[index]+=mH400_weight; Err2OfwgtmH400[index]+=mH400_weight*mH400_weight;
          }
          if(index==1 && mH400_mindR_l1j>fixed_cuts_min[0]&&mH400_mindR_l1j<fixed_cuts_max[0] &&
                         mH400_m_ll>fixed_cuts_min[1]&&mH400_m_ll<fixed_cuts_max[1]){
             numOfmH400[index]++;
             numOfwgtmH400[index]+=mH400_weight; Err2OfwgtmH400[index]+=mH400_weight*mH400_weight;
          }
          if(index==2 && mH400_mindR_l1j>fixed_cuts_min[0]&&mH400_mindR_l1j<fixed_cuts_max[0] &&
                         mH400_m_ll>fixed_cuts_min[1]&&mH400_m_ll<fixed_cuts_max[1] &&
                         mH400_m_l1jj>fixed_cuts_min[2]&&mH400_m_l1jj<fixed_cuts_max[2]){
             numOfmH400[index]++;
             numOfwgtmH400[index]+=mH400_weight; Err2OfwgtmH400[index]+=mH400_weight*mH400_weight;
          }
          if(index==3&&mH400_mindR_l1j>fixed_cuts_min[0]&&mH400_mindR_l1j<fixed_cuts_max[0] &&
                         mH400_m_ll>fixed_cuts_min[1]&&mH400_m_ll<fixed_cuts_max[1] &&
                         mH400_m_l1jj>fixed_cuts_min[2]&&mH400_m_l1jj<fixed_cuts_max[2] &&
                         mH400_m_all>fixed_cuts_min[3]&&mH400_m_all<fixed_cuts_max[3]){
              numOfmH400[index]++;
             numOfwgtmH400[index]+=mH400_weight; Err2OfwgtmH400[index]+=mH400_weight*mH400_weight;
          }
      }
      for(Long64_t entry=0; entry<mH500->GetEntries();entry++) {
          ...
          if(index==0 &&mH500_mindR_l1j>fixed_cuts_min[0]&&mH500_mindR_l1j<fixed_cuts_max[0]){
             numOfmH500[index]++;
             numOfwgtmH500[index]+=mH500_weight; Err2OfwgtmH500[index]+=mH500_weight*mH500_weight;
          }
          if(index==1 && mH500_mindR_l1j>fixed_cuts_min[0]&&mH500_mindR_l1j<fixed_cuts_max[0] &&
                         mH500_m_ll>fixed_cuts_min[1]&&mH500_m_ll<fixed_cuts_max[1]){
             numOfmH500[index]++;
             numOfwgtmH500[index]+=mH500_weight; Err2OfwgtmH500[index]+=mH500_weight*mH500_weight;
          }
          if(index==2 && mH500_mindR_l1j>fixed_cuts_min[0]&&mH500_mindR_l1j<fixed_cuts_max[0] &&
                         mH500_m_ll>fixed_cuts_min[1]&&mH500_m_ll<fixed_cuts_max[1] &&
                         mH500_m_l1jj>fixed_cuts_min[2]&&mH500_m_l1jj<fixed_cuts_max[2]){
             numOfmH500[index]++;
             numOfwgtmH500[index]+=mH500_weight; Err2OfwgtmH500[index]+=mH500_weight*mH500_weight;
          }
          if(index==3&&mH500_mindR_l1j>fixed_cuts_min[0]&&mH500_mindR_l1j<fixed_cuts_max[0] &&
                         mH500_m_ll>fixed_cuts_min[1]&&mH500_m_ll<fixed_cuts_max[1] &&
                         mH500_m_l1jj>fixed_cuts_min[2]&&mH500_m_l1jj<fixed_cuts_max[2] &&
                         mH500_m_all>fixed_cuts_min[3]&&mH500_m_all<fixed_cuts_max[3]){
              numOfmH500[index]++;
             numOfwgtmH500[index]+=mH500_weight; Err2OfwgtmH500[index]+=mH500_weight*mH500_weight;
          }
      }
      for(Long64_t entry=0; entry<nonres->GetEntries();entry++) {
          ...
          if(index==0 &&nonres_mindR_l1j>fixed_cuts_min[0]&&nonres_mindR_l1j<fixed_cuts_max[0]){
             numOfnonres[index]++;
             numOfwgtnonres[index]+=nonres_weight; Err2Ofwgtnonres[index]+=nonres_weight*nonres_weight;
          }
          if(index==1 && nonres_mindR_l1j>fixed_cuts_min[0]&&nonres_mindR_l1j<fixed_cuts_max[0] &&
                         nonres_m_ll>fixed_cuts_min[1]&&nonres_m_ll<fixed_cuts_max[1]){
             numOfnonres[index]++;
             numOfwgtnonres[index]+=nonres_weight; Err2Ofwgtnonres[index]+=nonres_weight*nonres_weight;
          }
          if(index==2 && nonres_mindR_l1j>fixed_cuts_min[0]&&nonres_mindR_l1j<fixed_cuts_max[0] &&
                         nonres_m_ll>fixed_cuts_min[1]&&nonres_m_ll<fixed_cuts_max[1] &&
                         nonres_m_l1jj>fixed_cuts_min[2]&&nonres_m_l1jj<fixed_cuts_max[2]){
             numOfnonres[index]++;
             numOfwgtnonres[index]+=nonres_weight; Err2Ofwgtnonres[index]+=nonres_weight*nonres_weight;
          }
          if(index==3&&nonres_mindR_l1j>fixed_cuts_min[0]&&nonres_mindR_l1j<fixed_cuts_max[0] &&
                         nonres_m_ll>fixed_cuts_min[1]&&nonres_m_ll<fixed_cuts_max[1] &&
                         nonres_m_l1jj>fixed_cuts_min[2]&&nonres_m_l1jj<fixed_cuts_max[2] &&
                         nonres_m_all>fixed_cuts_min[3]&&nonres_m_all<fixed_cuts_max[3]){
              numOfnonres[index]++;
             numOfwgtnonres[index]+=nonres_weight; Err2Ofwgtnonres[index]+=nonres_weight*nonres_weight;
          }
      }
      ...
      for(Long64_t entry=0; entry<data->GetEntries();entry++) {
          ...
          if(index==0 &&data_mindR_l1j>fixed_cuts_min[0]&&data_mindR_l1j<fixed_cuts_max[0]){
             numOfdata[index]++;
             numOfwgtdata[index]+=data_weight; Err2Ofwgtdata[index]+=data_weight*data_weight;
          }
          if(index==1 && data_mindR_l1j>fixed_cuts_min[0]&&data_mindR_l1j<fixed_cuts_max[0] &&
                         data_m_ll>fixed_cuts_min[1]&&data_m_ll<fixed_cuts_max[1]){
             numOfdata[index]++;
             numOfwgtdata[index]+=data_weight; Err2Ofwgtdata[index]+=data_weight*data_weight;
          }
          if(index==2 &&data_mindR_l1j>fixed_cuts_min[0]&&data_mindR_l1j<fixed_cuts_max[0] &&
                         data_m_ll>fixed_cuts_min[1]&&data_m_ll<fixed_cuts_max[1] &&
                         data_m_l1jj>fixed_cuts_min[2]&&data_m_l1jj<fixed_cuts_max[2] ){
             numOfdata[index]++;
             numOfwgtdata[index]+=data_weight; Err2Ofwgtdata[index]+=data_weight*data_weight;
          }
          if(index==3&&data_mindR_l1j>fixed_cuts_min[0]&&data_mindR_l1j<fixed_cuts_max[0] &&
                        data_m_ll>fixed_cuts_min[1]&&data_m_ll<fixed_cuts_max[1] &&
                         data_m_l1jj>fixed_cuts_min[2]&&data_m_l1jj<fixed_cuts_max[2] &&
                         data_m_all>fixed_cuts_min[3]&&data_m_all<fixed_cuts_max[3]){
              numOfdata[index]++;
             numOfwgtdata[index]+=data_weight; Err2Ofwgtdata[index]+=data_weight*data_weight;
          }
      }*/
      for(Long64_t entry=0; entry<totalbkg->GetEntries();entry++) {
          ...
          if(index==0 &&totalbkg_mindR_l1j>fixed_cuts_min[0]&&totalbkg_mindR_l1j<fixed_cuts_max[0]){
             numOftotalbkg[index]++;
          ...
          if(index==1 && totalbkg_mindR_l1j>fixed_cuts_min[0]&&totalbkg_mindR_l1j<fixed_cuts_max[0] &&
                         totalbkg_m_ll>fixed_cuts_min[1]&&totalbkg_m_ll<fixed_cuts_max[1]){
             numOftotalbkg[index]++;
             numOfwgttotalbkg[index]+=totalbkg_weight;
             if((*totalbkg_component)=="QmisID") {
                 numOfQmisID[index]++;
          ...
          if(index==2 &&totalbkg_mindR_l1j>fixed_cuts_min[0]&&totalbkg_mindR_l1j<fixed_cuts_max[0] &&
                        totalbkg_m_ll>fixed_cuts_min[1]&&totalbkg_m_ll<fixed_cuts_max[1] &&
                         totalbkg_m_l1jj>fixed_cuts_min[2]&&totalbkg_m_l1jj<fixed_cuts_max[2]){
             numOftotalbkg[index]++;
             numOfwgttotalbkg[index]+=totalbkg_weight;
             if((*totalbkg_component)=="QmisID") {
                 numOfQmisID[index]++;
          ...
          if(index==3&&totalbkg_mindR_l1j>fixed_cuts_min[0]&&totalbkg_mindR_l1j<fixed_cuts_max[0] &&
                        totalbkg_m_ll>fixed_cuts_min[1]&&totalbkg_m_ll<fixed_cuts_max[1] &&
                         totalbkg_m_l1jj>fixed_cuts_min[2]&&totalbkg_m_l1jj<fixed_cuts_max[2] &&
                         totalbkg_m_all>fixed_cuts_min[3]&&totalbkg_m_all<fixed_cuts_max[3]){
              numOftotalbkg[index]++;
              numOfwgttotalbkg[index]+=totalbkg_weight;
              if((*totalbkg_component)=="QmisID") {
                 numOfQmisID[index]++;
      ...
      sigs[index]=wgtsignal[index]/sqrt(wgttotalbkg[index]);
      sigpurs[index]=wgtsignal[index]/(wgttotalbkg[index]);
