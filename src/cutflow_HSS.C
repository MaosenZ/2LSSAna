...
void cutflow_HSS(TString masspoint, Int_t input_channel){
  ...
  TFile *f_signal; TFile *f_data; TFile *f_totalbkg;
  if(masspoint=="H280_S135" || masspoint=="H300_S135" || masspoint=="H320_S135"){
     f_data=new TFile("output/dataMC_2jets/miniNtuple_datacombined.root");
     f_totalbkg=new TFile("output/dataMC_2jets/miniNtuple_totalbkg.root");
     ff_ele=0.5401; ff_mu=0.5033; sys_ele=0.6309; sys_mu=0.6455;
  }
  if(masspoint=="H340_S135" || masspoint=="H340_S145" || masspoint=="H340_S155" || masspoint=="H340_S165"){
     f_data=new TFile("output/dataMC_3jets/miniNtuple_datacombined.root");
     f_totalbkg=new TFile("output/dataMC_3jets/miniNtuple_totalbkg.root");
